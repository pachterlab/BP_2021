...
def main(ds, out_dir, k_path, a_path):
    start = time.time()
    ...
    alevin_path = os.path.join(a_path, f"{ds}/quant/alevin/")
...
if __name__=="__main__":
    ...
    parser.add_argument("-k", help="kallisto bustools folder path")
    parser.add_argument("-s", help="salmon-alevin-fry (decoy) folder path")
    ...
    main(args.d, args.o, args.k, args.s)
