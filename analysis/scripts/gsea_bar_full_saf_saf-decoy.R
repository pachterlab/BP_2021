...
library(Matrix)
library(Seurat)
code_files <- paste0("./code/", c("find_clust_mirror", "gsea",
...
gsea_bar_full <- function(species, name_regex, mapping,
  ...
  mats$kallisto <- read_count_output_salmon(get_dir(name_regex, 
                                             "../../data/alevin_out_transcriptome"),
  ...
  print('Writing')
  write_csv(out, paste0("../../data/DE_saf_saf-decoy/gsea_bar/", name_use, ".csv"))
  write_csv(method_markers, paste0("../../data/DE_saf_saf-decoy/method_de/", name_use, ".csv"))
  
  # Save the QQ plot data frame
  write_csv(method_gsea, paste0("../../data/DE_saf_saf-decoy/gsea_qq/", name_use, ".csv"))
  # qq plot
}
